      ...
      delay: 0.1
        ...
        <div className="relative">
          ...
          <div className="flex gap-4">
            <button onClick={onRestart} className="flex-1 px-6 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl font-medium hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300">
              Try Again
            </button>
          </div>
        </div>
